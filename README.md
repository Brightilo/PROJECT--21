...
*  
* Download binaries for runc, crictl and containerd  wget https://github.com/opencontainers/runc/releases/download/v1.0.0-rc93/runc.amd64 \
...
*       runtime_root = ""
*   EOF  Create systemd service file for containerd cat <<EOF | sudo tee /etc/systemd/system/containerd.service
*   [Unit]
...
*   EOF  Create directories for to configure kubelet, kube-proxy, cni, and a directory to keep the kubernetes root ca file:   sudo mkdir -p \
*   /var/lib/kubelet \
*   /var/lib/kube-proxy \
*   /etc/cni/net.d \
*   /opt/cni/bin \
